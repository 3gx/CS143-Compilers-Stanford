...
public:
   ...
   virtual void check_inheritance_features(Class_) = 0;
   virtual void set_expression(Class_) = 0;
...
public:
   ...
   virtual Symbol get_expr_type(Class_) = 0;
...
public:
   ...
   void check_inheritance_features(Class_);
   void set_expression(Class_);
...
public:
   ...
   Symbol get_attr_name() { return name; }
...
public:
   ...
   Symbol get_method_name() { return name; }
   Expression get_e0() { return expr; }
   Expressions get_en() { return actual; }
   Symbol get_expr_type(Class_);
...
public:
   ...
   Symbol get_expr_type(Class_);
   Symbol process_case(Case, Class_);
